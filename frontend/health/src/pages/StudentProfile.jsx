...
const StudentProfile = () => {
  ...
  if (loading && isGeneratingResume) {

    return <div id="Loading_resume">Generating resume, please wait...</div>;
  }
  if(loading){
    return <div id="Loading_profile">Loading...</div>;
  }
  ...
  const fetchResumeData = async () => {
    ...
    // Simulate the async operation (API call or processing)
    generateResume().then(() => {
      setLoading(false);
