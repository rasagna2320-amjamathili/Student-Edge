...
const StudentHome = () => {
  ...
  const fetchStudentDetails = async () => {
    ...
    try {
      ...
      setTechEvents(data.techEvents.join(", ") || "");
      setExtraCurricular(data.extraCurricular.join(", ") || "");
      setCoCurricular(data.coCurricular.join(", ") || "");
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      formData.append("techEvents", techEvents);
      formData.append("extraCurricular", extraCurricular);
      formData.append("coCurricular", coCurricular);
      ...
      <div className="profile-card">
        ...
        <div className="form-container">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <input type="text" value={techEvents} onChange={(e) => setTechEvents(e.target.value)} placeholder="Enter your tech events" />
            <label>Extra-Curricular Activities</label>
            <input type="text" value={extraCurricular} onChange={(e) => setExtraCurricular(e.target.value)} placeholder="Enter your extra-curricular activities" />
            <label>Co-Curricular Activities</label>
            <input type="text" value={coCurricular} onChange={(e) => setCoCurricular(e.target.value)} placeholder="Enter your co-curricular activities" />
