...
# Configure API key
API_KEY = "AIzaSyAg2Ak6577CS7C5lpFeE0sUNNneKh7ucl8"
...
def generate_gemini_response(query):
    ...
    2. Expand all abbreviations (e.g., "SQL" → "Structured Query Language")
    3. Include both full forms and abbreviations in response
    4. Return ONLY computer science related terms
